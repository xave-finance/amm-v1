...
contract MockUsdcToUsdAssimilator is IAssimilator {
    using ABDKMath64x64 for int128;
    using ABDKMath64x64 for uint256;

    // IOracle private constant oracle = IOracle(0x9211c6b3BF41A10F78539810Cf5c64e1BB78Ec60);
    // IERC20 private constant usdc = IERC20(0x27A21D32375Ab8e3aFaa97B3635747d1F7e10531);
    ...
    constructor(IERC20 _quoteToken, IOracle _oracle) {
        usdc = _quoteToken;
        oracle = _oracle;
    }
