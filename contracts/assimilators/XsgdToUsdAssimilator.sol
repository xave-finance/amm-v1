...
contract XsgdToUsdAssimilator is IAssimilator {
    ...
    IOracle private constant oracle = IOracle(0x813f68DAC3d01D786C40016766F56E134E736458);
    IERC20 private constant usdc = IERC20(0x12513dd17Ae75AF37d9eb21124f98b04705Be906);
    IERC20 private constant xsgd = IERC20(0x51Ca80516644928dbf8c5af5853Dc01bfe8A8f43);
    ...
    // takes a numeraire account, calculates the raw amount of xsgd, transfers it in and returns the corresponding raw amount
    function intakeNumeraireLPRatio(
        ...
        uint256 _cadcBal = xsgd.balanceOf(_addr);
        ...
        returns (int128 amount_, int128 balance_)
    {
        ...
        bool _transferSuccess = xsgd.transfer(_dst, _cadcAmount);
