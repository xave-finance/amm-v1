...
async function main() {
  ...
  console.log('\r');
  // console.log('XSGD to emerg-withdraw: ', formatUnits(baseViewUser1, TOKENS_XSGD_DECIMALS));
  console.log('TCAD to emerg-withdraw: ', formatUnits(baseViewUser1, TOKENS_TCAD_DECIMALS));
  console.log('USDC to emerg-withdraw: ', formatUnits(quoteViewUser1, TOKENS_USDC_DECIMALS));
  console.log('\r');

  // const isEmergencyBefore = await curveXSGD
  //   .connect(user1)
  //   .emergency();
  const isEmergencyBefore = await curveTCAD
    .connect(user1)
    .emergency();
  ...
  // const isEmergencyAfter = await curveXSGD
  //   .connect(user1)
  //   .emergency();
  const isEmergencyAfter = await curveTCAD
    .connect(user1)
    .emergency();
  ...
  console.log('withdrawcurveTCAD: ', withdrawcurveTCAD);
