  ...
  describe("Pool Ratio changes between operations", function () {
    describe("viewDeposit", function () {
      const viewLPDepositWithSanityChecks = async ({
        ...
        // console.log('formatUnits(depositAmount): ', formatUnits(depositAmount));
        // console.log('baseDecimals: ', baseDecimals);
        // console.log('formatUnits(parseUnits(formatUnits(depositAmount), baseDecimals)): ', formatUnits(parseUnits(formatUnits(depositAmount), baseDecimals)))
        // console.log('expectedDepositAmountBase: ', formatUnits(expectedDepositAmountBase));
        // console.log('amount before power: ', formatUnits(parseUnits(formatUnits(depositAmount), baseDecimals)));
        // console.log('manual multiple by 8: ', parseInt(formatUnits(parseUnits(formatUnits(depositAmount), baseDecimals))) * 8);
        // console.log('power of 8: ', formatUnits(parseUnits(formatUnits(depositAmount), baseDecimals).mul(1e8)));
        // console.log('div by oracle: ', formatUnits(parseUnits(formatUnits(depositAmount), baseDecimals).mul(1e8).div(ORACLE_RATE)));


        console.log("---- UNIT TEST");
        console.log('expectedDepositAmountBase: ', formatUnits(expectedDepositAmountBase, baseDecimals));
        console.log('expectedDepositAmountQuote: ', formatUnits(expectedDepositAmountQuote, quoteDecimals));

        console.log('baseViewUser1: ', formatUnits(baseViewUser1, baseDecimals));
        console.log('quoteViewUser1: ', formatUnits(quoteViewUser1, quoteDecimals));
        console.log('--------------------------------------------------------');

        // console.log('ORACLE_RATE', ORACLE_RATE.toString());
        // console.log('expectedDepositAmountBase', expectedDepositAmountBase);
        // console.log('expectedDepositAmountQuote', expectedDepositAmountQuote);
